...
device =  "cuda:7"
epochs = 15
best_model_path = "/u/amagzari/wattrel-amagzari/REPOS/FGC/models/vit_b1.th"
results_path = "/u/amagzari/wattrel-amagzari/REPOS/FGC/results/vit_b1.json"
...
def accuracyA(preds, targs): return accuracy_score(preds[0], targs) # full
...
for epoch in range(epochs):
    ...
    print(f"Epoch {epoch+1}, Loss: {avg_loss:.4f}, Train Acc: {train_acc:.4f}, Val Acc: {val_acc:.4f}, LR: {current_lr:.6f}")
